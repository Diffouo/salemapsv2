...
public class CmdActivity extends AppCompatActivity implements LocationListener {

    private EditText nom, pdt, qte;
    ...
    private Button bt1;
    private ArrayList<Commande> mliste;
    CmdProduitAdapter padater = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Request query = new Request(CmdActivity.this);
        ...
        if (luser != null) {
            ...
            Intent i = new Intent(CmdActivity.this, LoginActivity.class);
        ...
        /*if (!SessionData.getInstance().getRole().equals("merchant")) {
            ...
            Toast.makeText(CmdActivity.this, "Desole, votre profil n'a pas acces a ce module", Toast.LENGTH_LONG).show();

            Intent i = new Intent(CmdActivity.this, HomeActivity.class);
        ...
        toolbar.setTitle("Nouvelle commande");
        setTitle("Nouvelle commande");
        if(toolbarText!=null && toolbar!=null) {
            toolbarText.setText("Nouvelle commande");
        ...
        mliste = new ArrayList<Commande>();
        cliste = new ArrayList<Customer>();
        spinlist = new ArrayList<String>();

        bt1 = (Button) findViewById(R.id.button); //spinner = (Spinner)findViewById(R.id.spinner);
        ...
        if (gpsLocation != null) {
            Toast.makeText(CmdActivity.this, "Provider gps has been selected.", Toast.LENGTH_LONG).show();
            onLocationChanged(gpsLocation);
        } else {
            Toast.makeText(CmdActivity.this, "Position GPS non determinee", Toast.LENGTH_LONG).show();
        }

        if (isConnected()) new HttpAsyncTask().execute("" + SessionData.getInstance().getIduser());

        else
            Toast.makeText(CmdActivity.this, "Veuillez vous connecter a internet.", Toast.LENGTH_LONG).show();
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ArrayList<Commande> produitsList = padater.produitList;
                String chaine = "";
                int q = 0;
                ...
                for (int i = 0; i < produitsList.size(); i++) {
                    ...
                    if (p.getProduit().isSelected()) {
                        ...
                        if (q == 0)
                            chaine += "" + idproduit + ";" + p.getQte() + ";" + p.getType();
    ...
    public void onBackPressed() {
        ...
        Intent i2 = new Intent(CmdActivity.this, HomeActivity.class);
    ...
    public static String POST(String chaine,String xlocation,String ylocation,String user) throws IOException, JSONException {

        String lien = MainActivity.endpoint+"/rws-order/create";
        ...
        for(int a = 0; a < chaitab.length; a++) {
            ...
            json1.accumulate("unity_or_box", currentab[2]);
        ...
        try {
            ...
            jsonObject.accumulate("orderLines", jsonArray);
    ...
    private class HttpAsyncTask extends AsyncTask<String, Void, String> {
            ...
            if(t[0] != null){
                ...
                try {
                    ...
                    for(int i=0; i< tab.length(); i++){
                        ...
                        Commande commande = new Commande(); commande.setProduit(p); commande.setQte(0);

                        mliste.add(commande);

                    }

                    padater = new CmdProduitAdapter(CmdActivity.this,R.layout.produit_list,mliste);
        ...
        protected void onPreExecute() {
            ...
            pd = new ProgressDialog(CmdActivity.this);
            ...
            try {
                ...
                if(retour instanceof JSONObject) {
                    ...
                    if(obj.has("message")) {
                        ...
                        msgBox.setMessage("Commande enregistrée avec succès");
