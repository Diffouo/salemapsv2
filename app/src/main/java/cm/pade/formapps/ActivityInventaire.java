...
public class ActivityInventaire extends AppCompatActivity implements LocationListener {

    private Toolbar toolbar;
    DrawerLayout drawerLayout;
    ActionBarDrawerToggle drawerToggle;
    private ArrayList<Distributeur> dliste;
    private Spinner spinner;
    private List<String> spinlist;
    private ArrayList<Produit> pliste;
    private Spinner spinner2;
    private List<String> spinlist2;
    private EditText qte1, qte2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Request query = new Request(ActivityInventaire.this);
        ...
        if (luser != null) {
            ...
            Intent i = new Intent(ActivityInventaire.this, LoginActivity.class);
        ...
        if(toolbarText!=null && toolbar!=null) {
            toolbarText.setText("Inventaire");
        ...
        qte1 = (EditText) findViewById(R.id.editText4);
        qte2 = (EditText) findViewById(R.id.editText5);

        bt1 = (Button) findViewById(R.id.button);

        dliste = new ArrayList<Distributeur>();
        spinlist = new ArrayList<String>();

        pliste = new ArrayList<Produit>();
        ...
        if (gpsLocation != null) {
            Toast.makeText(ActivityInventaire.this, "Provider gps has been selected.", Toast.LENGTH_LONG).show();
            onLocationChanged(gpsLocation);
        } else {
            Toast.makeText(ActivityInventaire.this, "Position GPS non determinee", Toast.LENGTH_LONG).show();
        }

        if (isConnected()) new HttpAsyncTask().execute("" + SessionData.getInstance().getIduser());

        else
            Toast.makeText(ActivityInventaire.this, "Veuillez vous connecter a internet.", Toast.LENGTH_LONG).show();
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!dliste.isEmpty()) {
                    ...
                    for (int k = 0; k < dliste.size(); k++) {

                        if (dliste.get(k).getName().equals(selectspin)) {

                            idselect = dliste.get(k).getId();
                            current = dliste.get(k);
                        }
                    }
                ...
                Produit current2 = new Produit();

                for (int k = 0; k < pliste.size(); k++) {

                    if (pliste.get(k).getName().equals(selectspin2)) {

                        idselect2 = pliste.get(k).getId();
                        current2 = pliste.get(k);
                    }
                }

                if (qte1.getText().toString().isEmpty()) {
                    msgBox.setMessage("Veuillez saisir la quantité actuelle");
                    msgBox.openSimplePane();

                } else if (qte2.getText().toString().isEmpty()) {
                    msgBox.setMessage("Veuillez saisir la quantite critique");
                    msgBox.openSimplePane();
                    ...
                    new HttpAsyncTask1().execute(qte1.getText().toString(), qte2.getText().toString(), "" + Latitude, "" + Longitude, "" + idselect, "" + idselect2);
    ...
    public void onBackPressed() {
        ...
        Intent i2 = new Intent(ActivityInventaire.this, HomeActivity.class);
    ...
    public String GET(String key) {
        ...
        String lien = MainActivity.endpoint+"/rws-wholesaler?regional_responsible="+id;
    ...
    public static String POST(String qte1,String qt2,String xlocation,String ylocation,String distributeur,String produit) throws IOException, JSONException {

        String lien = MainActivity.endpoint+"/rws-wholesaler-inventory/create";
        ...
        try {
            ...
            jsonObject.accumulate("wholesaler", Integer.parseInt(distributeur));
            jsonObject.accumulate("product", Integer.parseInt(produit));
            jsonObject.accumulate("created_by", SessionData.getInstance().getIduser());
            jsonObject.accumulate("current_quantity", Integer.parseInt(qte1));
            jsonObject.accumulate("alert_quantity", Integer.parseInt(qt2));
    ...
    private class HttpAsyncTask extends AsyncTask<String, Void, String> {
            ...
            if(t[0] != null){
                ...
                try {
                    ...
                    for(int i=0; i< tab.length(); i++){
                        ...
                        pliste.add(p); spinlist2.add(pd.getString("name"));

                    }

                    ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(ActivityInventaire.this, android.R.layout.simple_spinner_item, spinlist2);
            ...
            if(t[1] != null){
                ...
                try {
                    ...
                    for(int i=0; i< tab1.length(); i++){
                        ...
                        dliste.add(distributeur); spinlist.add(cu.getString("name"));

                    }

                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(ActivityInventaire.this, android.R.layout.simple_spinner_item, spinlist);
        ...
        protected void onPreExecute() {
            ...
            pd = new ProgressDialog(ActivityInventaire.this);
