...
public class HttpRequest {
     ...
     * Writes query to open stream to server
     *
     * @param jsonInputString JSONObject params to open stream to server
     * @return HttpRequest this instance -> for chaining method @see line 22
     * @throws IOException - should be checked by caller
     * */
    public String withJSON(String wbsLink, String jsonInputString) throws IOException{
        URL url = new URL (wbsLink);
        HttpURLConnection cnx = (HttpURLConnection)url.openConnection();
        cnx.setRequestMethod("POST");
        cnx.setRequestProperty("Content-Type", "application/json; utf-8");
    ...
    public String sendJSON(String wbsLink, String jsonInputString) throws IOException{
        URL url = new URL (wbsLink);
        HttpURLConnection cnx = (HttpURLConnection)url.openConnection();
        cnx.setRequestMethod("POST");
        cnx.setRequestProperty("Content-Type", "application/json; utf-8");
